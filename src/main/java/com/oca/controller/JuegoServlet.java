...
public class JuegoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if ("tirar".equals(accion)) {
            ...
            // ✅ AÑADIMOS EL DADO A LA URL
            // Si la variable 'dado' no se ha usado (ej: estaba castigado), mandamos 0
            int valorDado = (mensaje.contains("Dado")) ? dado : 0; 
            
            // Redirigir al tablero con mensaje Y dado
            response.sendRedirect("tablero.jsp?msg=" + mensajeCodificado + "&dado=" + valorDado);
}